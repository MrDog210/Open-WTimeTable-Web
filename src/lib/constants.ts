export const HTTP_PROXY = import.meta.env.VITE_HTTP_PROXY
...
export const APP_PLAY_STORE = 'https://play.google.com/store/apps/details?id=com.mrdog210.OpenWTimeTable2'
